...
Интернет-магазин парфюмерии в Беларуси. Дизайн-система и более 450 экранов в Figma на трёх брейкпоинтах, перенос сайта на Next.js с headless-каталогом из Aspro/Битрикс.

<table>
  <tr><td width="130"><b>Задача</b></td><td>Спроектировать интерфейс магазина на единой дизайн-системе и перенести сайт с шаблона Aspro на собственный фронтенд, сохранив каталог в Битриксе</td></tr>
...
Магазин работал на готовом решении Aspro для 1С-Битрикс. Нужно было:

- собрать интерфейс на единой дизайн-системе и покрыть макетами все сценарии покупки на трёх брейкпоинтах;
- перенести витрину на собственный фронтенд, оставив Битрикс источником данных каталога.
